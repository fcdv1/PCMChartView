...
int generateWaveBuffer(unsigned char *inputPcmBuffer,uint32_t pcmBufferByteLength, uint32_t frequency, uint16_t channleCount, uint16_t bitPerChannle, unsigned char **outputWavBuffer, int *waveBufferByteLength){
